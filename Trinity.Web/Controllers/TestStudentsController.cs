...
namespace Trinity.Web.Controllers
{
    public class TestStudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,FirstName,LastName,Telephone,Email,PhotoURL")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,FirstName,LastName,Telephone,Email,PhotoURL")] Student student)
        {
            if (ModelState.IsValid)
            {
